...
<div class="container-fluid">
                                    ...
                                    @foreach($brands as $brand)
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <a href="javascript:void(0)"  data-id="{{ $brand->id }}" class="action-icon text-success"  data-bs-toggle="modal" data-bs-target="#fieldServiceTypeEdit"> <i class="mdi mdi-square-edit-outline"></i></a></td>
                                        </tr>
                                    @endforeach
                                @endisset
                            </tbody>
    ...
    <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ URL::to('/admin/brand/store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    <label for="example-input-normal" class="form-label">Brand Name</label>
    ...
    <div id="fieldServiceTypeEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fieldServiceTypeEditLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="fieldServiceTypeEditLabel">Edit Brand</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="brand_id" hidden name="brandId" class="form-control">
                                    @error('name')
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
...
<script>
    $('#fieldServiceTypeEdit').on('show.bs.modal', function (event) {
        ...
        $.ajax({
            url: "{{ URL::to('admin/brand/') }}/" + id,
            method: 'GET',
            success: function (data) {
                console.log(data);
                
                $('#brand_id').val((data.data.brand.id));
                $('#name').val(data.data.brand.name);
