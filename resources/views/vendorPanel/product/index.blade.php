...
?>
                                    ...
                                    <td>
                                    <a href="{{ URL::to('vendor/product/'.$product->id.'/gallery') }}" class="btn btn-success">Gallery</a>
                                    <a href="{{ URL::to('vendor/product/'.$product->id) }}" class="btn btn-info">View</a>
    ...
    <div id="standard-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ URL::to('/vendor/product/store') }}" enctype="multipart/form-data" method="post">
                    @csrf
...
<script>
    $('#fieldServiceTypeEdit').on('show.bs.modal', function (event) {
        ...
        $.ajax({
            url: "{{ URL::to('vendor/categories/') }}/" + id,
            method: 'GET',
    ...
    fetchSubCategory = () => {
        ...
        $.ajax({
            url: "{{ URL::to('vendor/categories') }}" + "/" + categoryId + "/sub-categories",
            type: 'GET',
            data: {},
            success: function(data) {
                console.log(data);
